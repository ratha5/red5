	...
	if($count > 0){
		...
		echo 
				...
				'<form action="just.php" method="post">
				  ...
				  while($row=mysqli_fetch_array($run_query)){
					  $x++;
				 echo  '<input type="hidden" name="item_name_" value="'.$row["product_title"].'">
				 <input type="hidden" name="username" value="'.$uid.'">
				  <input type="hidden" name="item_number_" value="'.$x.'">
				  <input type="hidden" name="amount" value="'.$row["price"].'">
				  <input type="hidden" name="quantity_" value="'.$row["qty"].'">';
				...
				<input style="float:right;margin-right:80px;" type="submit" name="submit" value="Order Now"
